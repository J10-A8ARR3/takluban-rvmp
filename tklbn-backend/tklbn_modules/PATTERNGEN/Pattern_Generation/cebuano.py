...
def main():
    ...
    predefined_rules_path = f"{base_path}/tklbn-backend/tklbn-modules/PATTERNGEN/Pattern_Generation/predefined_rules.csv"
    model_filename = '../takluban-rvmp/tklbn-backend/tklbn-modules/POS/FSPOST/filipino-left5words-owlqn2-distsim-pref6-inf2.tagger'
    path_to_jar = '../takluban-rvmp/tklbn-backend/tklbn-modules/POS/FSPOST/stanford-postagger-full-2020-11-17/stanford-postagger.jar'
    ...
    # Load your dataset
    df = pd.read_csv('../takluban-rvmp/tklbn-backend/datasets/RAW/dataset_cebuano.csv')
