...
output_file = "../tklbn-backend/datasets/OUTPUT/POSdata.csv"
profanity_dictionary_file = "../tklbn-backend/tklbn_modules/PATTERNGEN/Pattern_Generation/profane_dictionary.csv"
...
def get_pattern_generator(language):
    predefined_rules_path = "../tklbn-backend/tklbn_modules/PATTERNGEN/Pattern_Generation/predefined_rules.csv"
    model_filename = '../tklbn-backend/tklbn_modules/POS/FSPOST/filipino-left5words-owlqn2-distsim-pref6-inf2.tagger'
    path_to_jar = '../tklbn-backend/tklbn_modules/POS/FSPOST/stanford-postagger-full-2020-11-17/stanford-postagger.jar'
    if language == 'tagalog':
...
def main():
    ...
    svm_model_path = "../takluban-rvmp/tklbn-backend/trained_profane_model.pkl"
