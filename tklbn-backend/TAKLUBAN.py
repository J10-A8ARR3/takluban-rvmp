...
output_file = "../takluban-rvmp/tklbn-backend/datasets/OUTPUT/POSdata.csv"
...
def get_pattern_generator(language):
    predefined_rules_path = "../takluban-rvmp/tklbn-backend/tklbn_modules/PATTERNGEN/Pattern_Generation/predefined_rules.csv"
